...
public partial class FumenVisualEditorViewModel : PersistedDocument, ISchedulable, IFumenEditorDrawingContext
{
	...
	End:
		if (IsDisplayFPS)
		{
			DWriteCore.DrawRaw(DisplayFPS, new(0,16), 12, new(1,1,1,0.5f), Vortice.DirectWrite.FontStyle.Normal, Vortice.DirectWrite.FontWeight.Normal);
		}
		drawMap.Clear();
	...
	public TimeSpan ScheduleCallLoopInterval => TimeSpan.FromSeconds(0.5);
